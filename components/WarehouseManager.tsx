              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-4 py-2 text-sm focus:ring-2 focus:ring-indigo-500/20 outline-none"
                    value={newWh.name}
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    maxLength={3}
                    placeholder="WHE"
                    className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-4 py-2 text-sm font-mono uppercase focus:ring-2 focus:ring-indigo-500/20 outline-none"
                    value={newWh.prefix}
